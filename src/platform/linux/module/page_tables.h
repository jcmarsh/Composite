...
int pgtbl_entry_absent(paddr_t pt, unsigned long addr); // HERE. Not sure yet about these three
unsigned long get_valid_pgtbl_entry(paddr_t pt, int n); // Should likely just be given a more clear name.
